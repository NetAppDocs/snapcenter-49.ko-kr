...
+
cmdlet과 함께 사용할 수 있는 매개 변수와 이에 대한 설명은 get-Help_command_name_을 실행하여 얻을 수 있습니다. 또는 을 참조할 수도 있습니다 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["cmdlet 참조 가이드"^]
...
** Linux:_/var/opt/SnapCenter/scc/allowed_commands.config를 참조하십시오
