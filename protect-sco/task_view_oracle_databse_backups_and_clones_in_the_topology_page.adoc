...
또는 또는 을 참조할 수도 https://library.netapp.com/ecm/ecm_download_file/ECMLP2886206["SnapCenter 소프트웨어 명령 참조 가이드"^] https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["SnapCenter 소프트웨어 cmdlet 참조 가이드"^]있습니다.
