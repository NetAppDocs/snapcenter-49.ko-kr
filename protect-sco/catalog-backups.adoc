...
명령에 사용할 수 있는 매개 변수와 이에 대한 설명은 get-help command_name 을 실행하여 얻을 수 있습니다. 또는 를 참조할 수도 있습니다 https://library.netapp.com/ecm/ecm_download_file/ECMLP2886206["SnapCenter 소프트웨어 명령 참조 가이드"^].
