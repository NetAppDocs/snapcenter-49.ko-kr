...
SnapCenter Plug-in for VMware vSphere에서 CA 인증서를 구성하려면  https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["SSL 인증서를 생성하거나 가져옵니다"^]를 참조하십시오.
