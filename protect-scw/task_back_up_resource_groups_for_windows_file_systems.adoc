...
+
검색 상자에 리소스 그룹 이름을 입력하거나 을 클릭하여 리소스 그룹을 검색할 수 있습니다 image:../media/filter_icon.png[""] 태그를 선택합니다. 그런 다음 을 클릭할 수 있습니다 image:../media/filter_icon.png[""] 를 눌러 필터 창을 닫습니다.
