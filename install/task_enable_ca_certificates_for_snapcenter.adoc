...
* image:../media/enable_ca_issues_icon.png["문제 아이콘"]* * 플러그인 호스트에 활성화되거나 할당된 CA 인증서가 없음을 나타냅니다.
* image:../media/enable_ca_good_icon.png["좋은 아이콘입니다"]* * CA 인증서의 유효성 검사가 성공적으로 완료되었음을 나타냅니다.
* image:../media/enable_ca_failed_icon.png["실패 아이콘"]* * 는 CA 인증서의 유효성을 검사할 수 없음을 나타냅니다.
* image:../media/enable_ca_undefined_icon.png["정의되지 않은 아이콘"]*] * 연결 정보를 검색할 수 없음을 나타냅니다.
