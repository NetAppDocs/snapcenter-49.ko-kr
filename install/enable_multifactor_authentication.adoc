...
* cmdlet과 함께 사용할 수 있는 매개 변수 및 해당 설명은 를 실행하여 확인할 수 `Get-Help command_name`있습니다. 또는 을 참조하십시오 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["SnapCenter 소프트웨어 cmdlet 참조 가이드"^].
