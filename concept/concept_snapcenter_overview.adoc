...
+
사용자 정의 SnapCenter 플러그인을 만들 수 있는 프레임워크를 제공하여 다른 표준 또는 사용자 지정 애플리케이션 및 데이터베이스에서도 데이터 보호가 지원됩니다. 따라서 동일한 단일 창에서 다른 애플리케이션과 데이터베이스의 데이터를 보호할 수 있습니다. NetApp은 이 프레임워크를 활용하여 IBM DB2, MongoDB, MySQL 등을 위한 SnapCenter 맞춤형 플러그인을 출시했습니다.
...
+
Windows cmdlet에 대한 자세한 내용은 을 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["cmdlet 참조 가이드"^]참조하십시오.

+
UNIX 명령에 대한 자세한 내용은 을 참조하십시오 https://library.netapp.com/ecm/ecm_download_file/ECMLP2886206["SnapCenter 소프트웨어 명령 참조 가이드"^].
...
image::../media/snapcenter_architecture.gif[SnapCenter의 아키텍처]
